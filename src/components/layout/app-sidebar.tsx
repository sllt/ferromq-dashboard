...
const groups: NavGroup[] = [
  ...
  {
    titleKey: 'nav.diagnostic',
    items: [
      { to: '/alarms', labelKey: 'nav.alarms', icon: Bell },
      { to: '/logs', labelKey: 'nav.logs', icon: FileText },
      { to: '/trace', labelKey: 'nav.trace', icon: ScanSearch },
      { to: '/slow-subs', labelKey: 'nav.slowSubs', icon: Turtle },
      { to: '/topic-metrics', labelKey: 'nav.topicMetrics', icon: Gauge },
    ],
  },
  {
    titleKey: 'nav.cluster',
    items: [
      { to: '/cluster', labelKey: 'nav.clusterTopology', icon: Share2 },
